...
<div class="container mb-3 mt-3">
    <h2>Tambah Tugas</h2>
    <form method="post" action="/savetugas">
        @csrf
        <div class="mb-3 mt-3">
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control @error('deskripsiTugas') is-invalid @enderror" id="deskripsiTugas"
                name="deskripsiTugas" value="{{old('deskripsiTugas')}}">
        </div>
        @error('tglMulai')
        <div class="text-danger">{{$message}}</div>
        @enderror
        ...
        <div class="mb-3 mt-3">
            ...
            <div class="form-check">
                <input type="radio" class="form-check-input" id="radio1" name="statusTugas" value="Dalam Progress" @php if(old('statusTugas')
                    !='Dalam Progress' ){print('checked');} @endphp>
                <label class="form-check-label" for="radio1">Dalam Progress</label>
            </div>
            <div class="form-check">
                <input type="radio" class="form-check-input" id="radio2" name="statusTugas" value="Selesai" @php
                    if(old('statusTugas')=='Dalam Progress' ){print('checked');} @endphp>
