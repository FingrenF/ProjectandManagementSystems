@extends('master')
@section('title', 'Edit Tim Proyek')

@section('content')
<div class="container mb-3 mt-3">
    <h2>Edit Tim Proyek</h2>
    <form method="post"action="{{route('modiftim', $tim->id)}}">
        @csrf
        <div class="mb-3 mt-3">
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control @error('jumlahAnggota') is-invalid @enderror" id="jumlahAnggota"
                name="jumlahAnggota" value="{{$tim->jumlahAnggota}}">
            @error('jumlahAnggota')
            <div class="text-danger">{{$message}}</div>
            @enderror
        </div>
        <div class="mb-3 mt-3">
            ...
            <input type="date" class="form-control @error('tglPembentukan') is-invalid @enderror" id="tglPembentukan"
                name="tglPembentukan" value="{{$tim->tglPembentukan}}">
        </div>
